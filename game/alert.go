...
// responses happening before the memory is correct.
//
// If the player to alert is the computer player then their move is automatically made (resulting
// in an alert back to the originating player).
